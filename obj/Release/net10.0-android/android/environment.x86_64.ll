...
@aot_dso_cache = dso_local local_unnamed_addr global [792 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 u0x3594f01f1dba2359, ; from name: aot-Subscription_tracker.dll.so
		i64 u0xb04c8b37977802d8, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Subscription_tracker.dll.so
		ptr null; void* handle
	}, ; 155
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x4e45c82b01c004f1, ; from name: libaot-Subscription_tracker.so
		i64 u0xb04c8b37977802d8, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Subscription_tracker.dll.so
	...
	%struct.DSOCacheEntry {
		i64 u0x5d4a4248f5e21f50, ; from name: Subscription_tracker
		i64 u0xb04c8b37977802d8, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Subscription_tracker.dll.so
	...
	%struct.DSOCacheEntry {
		i64 u0x70a1f17148d0cbbb, ; from name: Subscription_tracker.so
		i64 u0xb04c8b37977802d8, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Subscription_tracker.dll.so
	...
	%struct.DSOCacheEntry {
		i64 u0x7843ce8bebd2b77e, ; from name: aot-Subscription_tracker
		i64 u0xb04c8b37977802d8, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Subscription_tracker.dll.so
	...
	%struct.DSOCacheEntry {
		i64 u0x7da3dbd6e5606671, ; from name: aot-Subscription_tracker.so
		i64 u0xb04c8b37977802d8, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Subscription_tracker.dll.so
	...
	%struct.DSOCacheEntry {
		i64 u0xb04c8b37977802d8, ; from name: libaot-Subscription_tracker.dll.so
		i64 u0xb04c8b37977802d8, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Subscription_tracker.dll.so
	...
	%struct.DSOCacheEntry {
		i64 u0xd4f2550a1d032b69, ; from name: Subscription_tracker.dll.so
		i64 u0xb04c8b37977802d8, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Subscription_tracker.dll.so
	...
	%struct.DSOCacheEntry {
		i64 u0xeb47fe0a7ac2f642, ; from name: libaot-Subscription_tracker
		i64 u0xb04c8b37977802d8, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Subscription_tracker.dll.so
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [37 x i8] c"com.companyname.subscription_tracker\00", align 16
...
@.DSOCacheEntry.8_name = private unnamed_addr constant [35 x i8] c"libaot-Subscription_tracker.dll.so\00", align 16
